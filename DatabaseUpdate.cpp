...
void DatabaseUpdate::CreateGameobjectInsert(const char* wdbdb, const char* worlddb, Database* DB, const char* home, bool own_style)
{
    ...
    insertsql.append(DATATRAP_FILE_HEADER).append("SET NAMES `utf8`;\n"
        ...
        "`questItem1`,`questItem2`,`questItem3`,`questItem4`" // NEU!!!
        ") VALUES\n('");
...
void DatabaseUpdate::CreateGameobjectUpdate(const char* wdbdb, const char* worlddb, Database* DB, const char* home, bool own_style, Tokens columns)
{
    ...
    query.append("SELECT WDB.entry, WDB.type, WORLD.type, WDB.displayId, WORLD.displayId, WDB.name, WORLD.name,"
        ...
        " WDB.size, WORLD.size,"
        " WDB.questItem1, WORLD.questItem1, WDB.questItem2, WORLD.questItem2, WDB.questItem3, WORLD.questItem3, WDB.questItem4, WORLD.questItem4" // NEU!!!
        " FROM `");

    ...
    switch(wdbfile)
    {
        ...
        case GAMEOBJECTCACHE:
	        def->setWDBName(WDB_FILE_GAMEOBJECT);
	        {
		        ...
		        def->addField(t_uint32, "data0");
		        def->addField(t_uint32, "data1");
		        def->addField(t_uint32, "data2");
		        def->addField(t_uint32, "data3");
		        def->addField(t_uint32, "data4");
		        def->addField(t_uint32, "data5");
		        def->addField(t_uint32, "data6");
		        def->addField(t_uint32, "data7");
		        def->addField(t_uint32, "data8");
		        def->addField(t_uint32, "data9");
		        def->addField(t_uint32, "data10");
		        def->addField(t_uint32, "data11");
		        def->addField(t_uint32, "data12");
		        def->addField(t_uint32, "data13");
		        def->addField(t_uint32, "data14");
		        def->addField(t_uint32, "data15");
		        def->addField(t_uint32, "data16");
		        def->addField(t_uint32, "data17");
		        def->addField(t_uint32, "data18");
		        def->addField(t_uint32, "data19");
		        def->addField(t_uint32, "data20");
		        def->addField(t_uint32, "data21");
		        def->addField(t_uint32, "data22");
		        def->addField(t_uint32, "data23");
